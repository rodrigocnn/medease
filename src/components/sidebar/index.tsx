          ...
          <ul className="ml-4 space-y-2 font-medium">
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002
                   2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Produtos</span>
              </Link>
            </li>
